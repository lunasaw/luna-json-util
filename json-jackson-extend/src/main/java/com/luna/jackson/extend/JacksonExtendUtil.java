package com.luna.jackson.extend;
...
import com.luna.jackson.JacksonUtil;
...
public class JacksonExtendUtil extends JacksonUtil {
    ...
    public static <V> void toCsvFile(String path, String separator, List<V> list) {
        try (Writer writer = new FileWriter(new File(path), true)) {
            ...
            throw new JacksonException("jackson to csv file error, path: {}, separator: {}, list: {}", path, separator,
                list, e);
        }
    }
    ...
    public static <V> void toCsvFile(String path, String separator, V v) {
        try (Writer writer = new FileWriter(new File(path), true)) {
            ...
            throw new JacksonException("jackson to csv file error, path: {}, separator: {}, data: {}", path, separator,
                v, e);
        }
    }
    ...
    public static <V> void toXmlFile(String path, V v, boolean isIndent) {
        try (Writer writer = new FileWriter(new File(path), true)) {
            ...
            throw new JacksonException("jackson to xml file error, path: {}, data: {}, isIndent: {}", path, v, isIndent,
                e);
        }
    }
        ...
        prop.forEach((k, v) -> {
            if (null != v && ClassUtils.isAssignable(v.getClass(), Map.class)) {
                HashMap<String, Object> from =
                    JacksonUtil.from(JacksonUtil.to(v), new TypeReference<HashMap<String, Object>>() {});
    ...
    private static HashMap<String, Object> recursion(String previousKey, HashMap<String, Object> result,
